program solve_cont_main
  ...
  integer, parameter :: nihalo = 1024, njhalo = 1024, nz = 3
  ...
  IC_h_fnm = '/glade/scratch/yueyanglu/forc_uvh_sm33/sol_h_fromU/h_snap__0021_001_00.nc'
  !dir_exp = '/glade/work/yueyanglu/MOM6_OUT/tr_off_64/'
  flnm_h = 'h_snap__YEAR_DAY_HR.nc' !h_snap__YEAR_DAY_HR
  ! 
  flx_dir = '/glade/scratch/yueyanglu/forc_uvh_sm33/sol_uvhm/'
  ...
  ! 
  dir_save = '/glade/scratch/yueyanglu/forc_uvh_sm33/sol_h_fromU/'
